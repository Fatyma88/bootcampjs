...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"pages/property-detail/property-detail.api.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getPropertyDetailsFromAPI = void 0;
...
// URL de la API
var apiUrl = 'https://api.localhost:3000/properties/property-detail';

// Función para obtener datos de la propiedad desde la API
var getPropertyDetailsFromAPI = exports.getPropertyDetailsFromAPI = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(propertyId) {
    var response, propertyData;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return fetch("".concat(apiUrl, "/").concat(propertyId));
        case 3:
          ...
          throw new Error("Error al obtener detalles de la propiedad. C\xF3digo: ".concat(response.status));
        case 6:
          _context.next = 8;
          return response.json();
        case 8:
          propertyData = _context.sent;
          return _context.abrupt("return", propertyData);
        case 12:
          _context.prev = 12;
          _context.t0 = _context["catch"](0);
          console.error('Error en la solicitud a la API:', _context.t0.message);
  ...
  return function getPropertyDetailsFromAPI(_x) {
...
exports.mapPropertyToPage = void 0;
// property-detail.mappers.js

// Función para mapear los datos de la propiedad a la página HTML
var mapPropertyToPage = exports.mapPropertyToPage = function mapPropertyToPage(propertyData) {
  ...
  document.getElementById('rooms').textContent = "".concat(propertyData.rooms || 0, " habitaciones, ");
  document.getElementById('squareMeter').textContent = "".concat(propertyData.squareMeter || 0, " m\xB2, ");
  document.getElementById('bathrooms').textContent = "".concat(propertyData.bathrooms || 0, " ba\xF1os");

  // Mapear precio
  document.getElementById('price').textContent = propertyData.price ? "".concat(propertyData.price, " \u20AC") : '';

  // Mapear notas y descripciones
  document.getElementById('notes').textContent = propertyData.notes || '';

  // Mapear características básicas
  var mainFeaturesList = document.getElementById('mainFeatures');
  mainFeaturesList.innerHTML = ''; // Limpiar la lista antes de agregar nuevas características
  propertyData.mainFeatures.forEach(function (feature) {
  ...
  // Mapear equipamiento
  var equipmentsList = document.getElementById('equipments');
  equipmentsList.innerHTML = '';
  propertyData.equipments.forEach(function (equipment) {
    var listItem = document.createElement('li');
  ...
  propertyData.images.forEach(function (image) {
    var listItem = document.createElement('li');
...
if (isId) {
  (0, _propertyDetail.getProperty)(params.id).then(function (apiProperty) {
    ...
    property = (0, _propertyDetail2.mapPropertyFromapiToVM)(apiProperty[0]);
    console.log(property);
    (0, _propertyDetail3.setImages)(property);
  });
}
