...
var propertyUrl = "".concat("http://localhost:3000/api", "/properties");
...
var getPropertyList = exports.getPropertyList = function getPropertyList(queryParams) {
  var url = queryParams ? "".concat(propertyUrl, "?").concat(queryParams) : propertyUrl;
...
},{"./element.helpers":"common/helpers/element.helpers.js"}],"pages/property-list/property-list.constants.js":[function(require,module,exports) {
"use strict";
